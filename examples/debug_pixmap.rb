...
# Подготовка атрибутов окна с событиями
...
rect_data.write_array_of_int16([10, 10, 180, 180])  # Почти весь пиксмап
XCB.xcb_poly_rectangle(conn, pixmap_id, gc_id, 1, rect_data)
XCB.xcb_flush(conn)
puts "✅ Нарисован большой черный прямоугольник в пиксмапе"
...
# Копирование пиксмапа в окно - в центре
XCB.xcb_copy_area(conn, pixmap_id, window_id, gc_id, 0, 0, 150, 100, 200, 200)
XCB.xcb_flush(conn)
puts "✅ Пиксмап скопирован в окно (позиция 150,100)"
